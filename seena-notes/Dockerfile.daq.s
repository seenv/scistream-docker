...
WORKDIR /flatbuffers
RUN cmake -G "Unix Makefiles"       #cmake -G "Unix Makefiles" -DCMAKE_INSTALL_PREFIX=$CONDA_PREFIX .
RUN make -j
RUN make install
...
#RUN cmake -DCMAKE_C_COMPILER=$(which mpicc) -DCMAKE_CXX_COMPILER=$(which mpicxx) \
#    -DFLATBUFFERS_FLATC_EXECUTABLE=$(which flatc) -DCMAKE_INSTALL_PREFIX=$CONDA_PREFIX ..
RUN make
